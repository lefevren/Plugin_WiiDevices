    ...
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            ...
            if ( event == eFE_Activate )
            {
                ...
                {
                    bool retour = CryVR_WiimoteManagerPlugin::SetTimeout( GetPortInt( pActInfo, 3 ) );
                    retour = retour && CryVR_WiimoteManagerPlugin::SetAccelThreshold( GetPortInt( pActInfo, 1 ), GetPortFloat( pActInfo, 2 ) );
                    retour = retour && CryVR_WiimoteManagerPlugin::SetAspectRatio( GetPortBool( pActInfo, 4 ) );
                    retour = retour && CryVR_WiimoteManagerPlugin::SetIRSensivity( GetPortInt( pActInfo, 5 ) );
        ...
        {
            return new CFlowWiimoteSetup( pActInfo );
        }
...
class CryVR_WiimoteMotionSensing : public CFlowBaseNode<eNCT_Instanced>
{
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            ...
            {
                bool retour = CryVR_WiimoteManagerPlugin::SetMotionSensing( GetPortInt( pActInfo, 1 ), GetPortBool( pActInfo, 2 ) );
                ActivateOutput( pActInfo, 0, retour );
            }
        }
        ...
        virtual IFlowNodePtr Clone( SActivationInfo* pActInfo )
        {
            return new  CryVR_WiimoteMotionSensing( pActInfo );
        }
        virtual void GetMemoryUsage( ICrySizer* s ) const
        {
            s->Add( *this );
...
class CryVR_WiimoteRumble : public CFlowBaseNode<eNCT_Instanced>
{
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            if ( event == eFE_Activate  && IsPortActive( pActInfo, 0 ) )
            {
                bool retour = CryVR_WiimoteManagerPlugin::ToggleRumble( GetPortInt( pActInfo, 1 ) );
                ActivateOutput( pActInfo, 0, retour );
            }
        ...
        virtual IFlowNodePtr Clone( SActivationInfo* pActInfo )
        {
            return new  CryVR_WiimoteRumble( pActInfo );
        }
        virtual void GetMemoryUsage( ICrySizer* s ) const
        {
            s->Add( *this );
...
class CryVR_WiimoteIR : public CFlowBaseNode<eNCT_Instanced>
{
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            if ( event == eFE_Activate  && IsPortActive( pActInfo, 0 ) )
            {
                bool retour = CryVR_WiimoteManagerPlugin::SetIr( GetPortInt( pActInfo, 2 ), GetPortBool( pActInfo, 3 ) );
                ActivateOutput( pActInfo, 0, retour );
            }

            if ( event == eFE_Activate  && IsPortActive( pActInfo, 1 ) )
            {
                bool retour = CryVR_WiimoteManagerPlugin::GetIr( GetPortInt( pActInfo, 2 ) );
                ActivateOutput( pActInfo, 0, retour );
            }
        }
        ...
        virtual IFlowNodePtr Clone( SActivationInfo* pActInfo )
        {
            return new  CryVR_WiimoteIR( pActInfo );
        }
        virtual void GetMemoryUsage( ICrySizer* s ) const
        {
            s->Add( *this );
    ...
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            ...
            if ( event == eFE_Activate )
            {
                if ( IsPortActive( pActInfo, 0 ) )
                {
                    bool retour = CryVR_WiimoteManagerPlugin::Stop();
                    ActivateOutput( pActInfo, 0, retour );
                }
            }
        }
        ...
        virtual IFlowNodePtr Clone( SActivationInfo* pActInfo )
        {
            return new CFlowWiimoteStop( pActInfo );
        }
        virtual void GetMemoryUsage( ICrySizer* s ) const
        {
            s->Add( *this );
...
class CryVR_WiimoteBatteryLevel : public CFlowBaseNode<eNCT_Instanced>
{
    public:
        ...
        virtual void ProcessEvent( EFlowEvent event, SActivationInfo* pActInfo )
        {
            if ( event == eFE_Activate  && IsPortActive( pActInfo, 0 ) )
            {
                float retour = CryVR_WiimoteManagerPlugin::GetBatteryLevel( GetPortInt( pActInfo, 1 ) );
                ActivateOutput( pActInfo, 0, retour );
            }
        ...
        virtual IFlowNodePtr Clone( SActivationInfo* pActInfo )
        {
            return new  CryVR_WiimoteBatteryLevel( pActInfo );
        }
        virtual void GetMemoryUsage( ICrySizer* s ) const
        {
            s->Add( *this );
