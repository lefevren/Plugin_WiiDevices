...
class CryVR_WiimoteControlerPlugin : public CFlowBaseNode<eNCT_Instanced>
{
    public:
        bool active;
        ...
        ////////////////////////////////////////////////////
        CryVR_WiimoteControlerPlugin( SActivationInfo* pActInfo ) :
            m_actInfo()
        {
        }
        ...
        ////////////////////////////////////////////////////
        virtual ~ CryVR_WiimoteControlerPlugin( void ) {}
        ...
        {
            return new  CryVR_WiimoteControlerPlugin( pActInfo );
        }
...
REGISTER_FLOW_NODE( "CryVR:Controlers:Wii_Plugin:Controler",  CryVR_WiimoteControlerPlugin );
