...
{
    CPluginWiiDevices* gPlugin = NULL;

    CPluginWiiDevices::CPluginWiiDevices()
    {
        gPlugin = this;
    }
    ...
    bool CPluginWiiDevices::Release( bool bForce )
    {
        bool bRet = true;
    ...
    bool CPluginWiiDevices::Init( SSystemGlobalEnvironment& env, SSystemInitParams& startupParams, IPluginBase* pPluginManager, const char* sPluginDirectory )
    {
    ...
    bool CPluginWiiDevices::RegisterTypes( int nFactoryType, bool bUnregister )
    {
    ...
    const char* CPluginWiiDevices::ListCVars() const
    {
        return "..."; // TODO: Enter CVARs/Commands here if you have some
    }

    const char* CPluginWiiDevices::GetStatus() const
    {
        return "OK";
    }
