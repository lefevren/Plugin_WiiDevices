...
class CryVR_WiimoteManagerPlugin : public CFlowBaseNode<eNCT_Instanced>
{
    ...
    public:
        ...
        CryVR_WiimoteManagerPlugin( SActivationInfo* pActInfo );
        static wiimote** GetWiimotes()
        {
            return wiimotes;
        }
        ...
        static bool GetMotionSensing( int id )
        {
            return WIIUSE_USING_ACC( wiimotes[id] );
        }
        ...
        virtual ~CryVR_WiimoteManagerPlugin( void );
        ...
        {
            return new CryVR_WiimoteManagerPlugin( pActInfo );
        }
