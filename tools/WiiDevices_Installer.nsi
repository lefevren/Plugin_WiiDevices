...
Name "WiiDevices Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_WiiDevices_${VERSION}.exe"
...
; Sections
Section "WiiDevices" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\WiiDevices"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\WiiDevices\Plugin_WiiDevices.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\WiiDevices\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\WiiDevices"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\WiiDevices\Plugin_WiiDevices.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\WiiDevices\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_WiiDevices"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_WiiDevices\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "WiiDevices Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the WiiDevices Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "WiiDevices Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_WiiDevices\changelog.md"'
FunctionEnd
